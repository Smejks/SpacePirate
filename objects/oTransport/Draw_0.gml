...
{
draw_text_transformed_color(oShip.x, oShip.y + 150, "TRANSPORT APROACHING WARP GATE!", 1.5, 1.5, 0, c_green, c_green, c_green, c_green, 1);
...
if (alertAuthorities > 1900)
{
draw_text_transformed_color(oShip.x, oShip.y + 150, "LAW ENFORCEMENT INBOUND!", 1.5, 1.5, 0, c_green, c_green, c_green, c_green, 1);
}